...
Rival1Pic::
Rival2Pic::
Rival3Pic::        INCBIN "pic/trainer/rival1.pic"
...
LarsPic::          INCBIN "pic/trainer/lars.pic"
TobiasPic::        INCBIN "pic/trainer/tobias.pic"
...
WyldaPic::         INCBIN "pic/trainer/druid.pic"
