...
BlkPacket_Battle:
	...
	ATTR_BLK_DATA %011, 0,0,0, 11,07, 19,10 ; player HP bar: pal 0
...
BlkPacket_StatusScreen:
	ATTR_BLK 1
	ATTR_BLK_DATA %111, 1,1,0, 01,01, 07,07 ; mon: pal 1, HP bar: pal 0
	ds 8
...
BlkPacket_TrainerCard:
	...
	ATTR_BLK_DATA %010, 4,4,0, 15,12, 16,13 ; Rainbow Badge
...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_LOGO1, PAL_TRUEHERO, PAL_PURPLEMON
PalPacket_TrainerCard:    PAL_SET PAL_TRUEHERO, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
