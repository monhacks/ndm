...
RocketData: ; TODO: replace with Myth Hunter
	...
	db 1,DRATINI,	MAGIKARP,	FARFETCHD, 	LICKITUNG, 	LAPRAS, 	CHARMANDER, 	HORSEA,		AERODACTYL,0
	db 1,DRAGONAIR,	GYARADOS,	KANGASKHAN, CHANSEY, 	LAPRAS, 	CHARMELEON, 	HORSEA,		AERODACTYL,0
	db 1,DRAGONAIR,	GYARADOS,	ARTICUNO, 	ZAPDOS, 	MOLTRES,	CHARMELEON, 	SEADRA,	AERODACTYL,0
	db 1,DRAGONITE,	GYARADOS,	ARTICUNO, 	ZAPDOS, 	MOLTRES,	CHARIZARD, 		SEADRA,	AERODACTYL,0
...
WyldaData: ; Viridian gym leader, growth-themed
	...
	db $FF,10,BEEDRILL,10,PARAS,10,EXEGGCUTE,10,NIDORAN_F,10,BULBASAUR,10,BELLSPROUT,0 ; 0 badge
	db $FF,18,BEEDRILL,18,PARAS,18,EXEGGCUTE,18,NIDORINA,18,IVYSAUR,18,WEEPINBELL,0 ; 1 badge
	db $FF,25,BEEDRILL,25,PARASECT,25,EXEGGUTOR,25,NIDOQUEEN,25,VENUSAUR,25,VICTREEBEL,0 ; 2 badges
	db $FF,30,BEEDRILL,30,PARASECT,30,EXEGGUTOR,30,NIDOQUEEN,30,VENUSAUR,30,VICTREEBEL,0 ; 3+ badges
...
LarsData: ; Pewter gym leader, mountain, tough themed
...
LtSurgeData: ; Vermilion gym leader, TODO: mod to Tori, mermaid performer
	db $FF,10,SHELLDER,10,STARYU,10,GYARADOS,10,SLOWPOKE,10,HORSEA,10,SEEL,0 ; 0 badge
	db $FF,18,SHELLDER,18,STARYU,18,GYARADOS,18,SLOWPOKE,18,HORSEA,18,SEEL,0 ; 1 badge
	db $FF,25,CLOYSTER,25,STARMIE,25,GYARADOS,25,SLOWBRO,25,SEADRA,25,DEWGONG,0 ; 2 badges
	db $FF,30,CLOYSTER,30,STARMIE,30,GYARADOS,30,SLOWBRO,30,SEADRA,30,DEWGONG,0 ; 3+ badges
...
BlaineData: ; Lavender town gym leader, TODO: mod to Aster, occultist
	db $FF,10,DROWZEE,10,OMANYTE,10,JYNX,10,TENTACOOL,10,ABRA,10,GASTLY,0 ; 0 badge
	db $FF,18,DROWZEE,18,OMANYTE,18,JYNX,18,TENTACRUEL,18,KADABRA,18,HAUNTER,0 ; 1 badge
	db $FF,25,HYPNO,25,OMASTAR,25,JYNX,25,TENTACRUEL,25,ALAKAZAM,25,GENGAR,0 ; 2 badges
	db $FF,30,HYPNO,30,OMASTAR,30,JYNX,30,TENTACRUEL,30,ALAKAZAM,30,GENGAR,0 ; 3+ badges
...
Green2Data:  ; alt rival ARBER
	db $FF,10,BELLSPROUT,10,SEEL,10,DITTO,10,MACHOP,10,RATTATA,10,PONYTA,0 ; 0 badge
	db $FF,18,WEEPINBELL,18,SEEL,18,DITTO,18,MACHOKE,18,RATICATE,18,PONYTA,0 ; 1 badge
	db $FF,25,VICTREEBEL,25,DEWGONG,25,DITTO,25,MACHAMP,25,TAUROS,25,RAPIDASH,0 ; 2 badges
	db $FF,30,VICTREEBEL,30,DEWGONG,30,DITTO,30,MACHAMP,30,TAUROS,30,RAPIDASH,0 ; 3+ badges
	
Green3Data:  ; female alt rival
	db $FF,10,ONIX,10,CLEFAIRY,10,DRATINI,10,SLOWPOKE,10,CHARMANDER,10,PIKACHU,0 ; 0 badge
	db $FF,18,ONIX,18,CLEFABLE,18,DRAGONAIR,18,SLOWPOKE,18,CHARMELEON,18,RAICHU,0 ; 1 badge
	db $FF,25,ONIX,25,CHANSEY,25,DRAGONAIR,25,SLOWBRO,25,CHARMELEON,25,ELECTABUZZ,0 ; 2 badges
	db $FF,30,ONIX,30,CHANSEY,30,DRAGONITE,30,SLOWBRO,30,CHARIZARD,30,ELECTABUZZ,0 ; 3+ badges
