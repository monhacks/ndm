...
MapSongBanks:
	...
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; ROUTE_16
	...
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; ROUTE_2_TRADE_HOUSE - MOD - Visigo Dungeon B1
	...
	db MUSIC_GYM, BANK(Music_Gym) ; MUSEUM_1F
	db MUSIC_GYM, BANK(Music_Gym) ; MUSEUM_2F
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; CERULEAN_TRADE_HOUSE
	...
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; POWER_PLANT
	...
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; CELADON_MANSION_2F
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; CELADON_MANSION_3F
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; CELADON_MANSION_ROOF
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; CELADON_MANSION_ROOF_HOUSE
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; CERULEAN_BADGE_HOUSE
