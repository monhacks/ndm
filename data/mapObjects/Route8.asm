Route8_Object:
	...
	warp 28, 11, 0, UNDERGROUND_PATH_ROUTE_8

	db 1 ; signs
	sign 17, 3, 10 ; Route8Text10

	db 9 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, 12,  5, STAY, RIGHT, 1, OPP_SUPER_NERD, 3
	...
	object SPRITE_BLACK_HAIR_BOY_2, 20,  7, STAY, RIGHT, 5, OPP_SUPER_NERD, 5
	object SPRITE_LASS, 27, 14, STAY, LEFT, 6, OPP_LASS, 14
	object SPRITE_LASS, 25, 12, STAY, RIGHT, 7, OPP_LASS, 15
	object SPRITE_GAMBLER, 41, 12, STAY, DOWN, 8, OPP_GAMBLER, 7
	object SPRITE_LASS, 48,  7, STAY, LEFT, 9, OPP_LASS, 16
	...
	warp_to 28, 11, ROUTE_8_WIDTH ; UNDERGROUND_PATH_ROUTE_8
